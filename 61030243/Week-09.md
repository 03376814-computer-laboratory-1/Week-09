...
![การใช้สีโดยการผสมค่าสี](./images/การใช้สีโดยการผสมค่าสี.PNG)
...
![ขนาดและสีของปากกา](./images/ขนาดและสีของปากกา.PNG)
...
![ชนิดของปากกาเป็นเส้นประ](./images/ชนิดของปากกาเป็นเส้นประ.PNG)
...
![การใช้ปากการ่วมกับแปลงทาสี](./images/การใช้ปากการ่วมกับแปลงทาสี.PNG)
...
![ใช้_Pen_ร่วมกับ_HatchBrush_เพื่อสร้างลายเส้นแบบต่างๆ](./images/ใช้_Pen_ร่วมกับ_HatchBrush_เพื่อสร้างลายเส้นแบบต่างๆ.PNG)
...
![การวาดเส้นตรงเชื่อมต่อระหว่างจุด_จำนวน_2_จุด](./images/การวาดเส้นตรงเชื่อมต่อระหว่างจุด_จำนวน_2_จุด.PNG)
...
![การวาดเส้นตรงด้วย_pen_style_และ_brush](./images/การวาดเส้นตรงด้วย_pen_style_และ_brush.PNG)
...
![Captureการกำหนดจุดปลายของเส้นตรงด้วย_style_แบบต่างๆ](./images/Captureการกำหนดจุดปลายของเส้นตรงด้วย_style_แบบต่างๆ.PNG)
...
![การวาดเส้นโค้งด้วยเมธอด_DrawCurve(...)](./images/การวาดเส้นโค้งด้วยเมธอด_DrawCurve(...).PNG)
...
![การวาดเส้นโค้งด้วย_Graphics-path](./images/การวาดเส้นโค้งด้วย_Graphics-path.PNG)
...
![การวาดสี่เหลี่ยมครั้งละรูป](./images/การวาดสี่เหลี่ยมครั้งละรูป.PNG)
...
![การวาดสี่เหลี่ยมพร้อมกันครั้งละหลายๆ_รูป](./images/การวาดสี่เหลี่ยมพร้อมกันครั้งละหลายๆ_รูป.PNG)
...
![การวาดวงกลมและวงรี](./images/การวาดวงกลมและวงรี.PNG)
...
![การวาดส่วนโค้ง_(Arc)](./images/การวาดส่วนโค้ง_(Arc).PNG)
### 3.5.4  การวาดรูป Pie
...
![การวาดรูป_Pie](./images/การวาดรูป_Pie.PNG)
...
![การสร้าง_graphics_path_จากรูปต่างๆ](./images/การสร้าง_graphics_path_จากรูปต่างๆ.PNG)
...
![การระบายสีด้วย_SolidBrush](./images/การระบายสีด้วย_SolidBrush.PNG)
...
![การระบายสีด้วย_HatchBrush](./images/การระบายสีด้วย_HatchBrush.PNG)
...
![การระบายสีด้วย_TextureBrush](./images/การระบายสีด้วย_TextureBrush.PNG)
...
![การระบายสีด้วย_TextureBrush_บน_panel](./images/การระบายสีด้วย_TextureBrush_บน_panel.PNG)
...
![การระบายสีด้วย_Path_Gradient_Brush](./images/การระบายสีด้วย_Path_Gradient_Brush.PNG)
...
![การโหลดภาพชนิดต่างๆ_มาแสดงบนฟอร์ม](./images/การโหลดภาพชนิดต่างๆ_มาแสดงบนฟอร์ม.PNG)
### 3.7.2 การ Zoom out
...
![การ_Zoom_out](./images/การ_Zoom_out.PNG)
...
![การพลิกและหมุนภาพ](./images/การพลิกและหมุนภาพ.PNG)
...
![การเขียนข้อความลงในภาพ](./images/การเขียนข้อความลงในภาพ.PNG)
...
```
![Draw_cartoon](./images/Draw_cartoon.PNG)
## References
