...
namespace _1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            Point[] pt =
            {
                new Point(220,270),new Point(270,270),
                new Point(250,290),new Point(220,270)
            };




            Brush n = new SolidBrush(Color.Black);
            Pen a = new Pen(n, 5);
            g.DrawEllipse(a, 150, 60, 190, 280);
            g.FillEllipse(Brushes.White, 150, 60, 190, 280);
            Rectangle tao = new Rectangle(200, 200, 100, 100);
            g.FillEllipse(Brushes.Yellow, tao);

            Rectangle tao1 = new Rectangle(220, 230, 15, 15);
            g.FillEllipse(Brushes.Black, tao1);


            Rectangle tao2 = new Rectangle(260, 230, 15, 15);
            g.FillEllipse(Brushes.Black, tao2);
